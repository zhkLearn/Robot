...
print("\n-------------------------------------------------------------------------------")
print("Test SStatsItem...")
local statItem = SStatsItem()
statItem.key = String("00_gold")
statItem.valInt = 10000
statItem.valFloat = 100.0
statItem.valString = String("Online")
print(statItem.key, statItem.valInt, statItem.valFloat, statItem.valString)

print("\n-------------------------------------------------------------------------------")
print("Test vectorStats...")
local statVect = vectorStats()
print("statVect:Size(): ", statVect:Size())
...
local gs = GameScene("f:/1.png", false);
print("gs:SaveToFile")
gs:SaveToFile("f:/1_bak.png")
